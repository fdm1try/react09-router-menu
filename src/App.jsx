...
function Menu() {
  ...
  return (
    <nav className="menu">
      <NavLink className={menuItemClass} to="/">Главная</NavLink>
      <NavLink className={menuItemClass} to="/drift">Дрифт-такси</NavLink>
      <NavLink className={menuItemClass} to="/timeattack">TIME ATTACK</NavLink>
      <NavLink className={menuItemClass} to="/forza">FORZA KARTING</NavLink>
    </nav>
  );
}
